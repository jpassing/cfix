	...
	)
{
	...
	if ( StackLocation->MinorFunction == IRP_MN_QUERY_INTERFACE )
	{
		if ( InlineIsEqualGUID( 
			 ...
			 StackLocation->Parameters.QueryInterface.Version == CFIXKR_REPORT_SINK_VERSION &&
	...
	)
{
	...
	CFIXKRP_TRACE(( "CFIXKR: Device created.\n" ));
