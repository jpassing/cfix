		  ...
		  <div class='footer'>
			...
			<div id='menu'>
				...
				<div id='submenu'>
					...
					<div id='submenusep'></div>
					<ul>
						<li><a href='http://sourceforge.net/project/downloading.php?group_id=218233&amp;use_mirror=osdn&amp;filename=cfix-binaries-1.0.0-rc1.zip&amp;14005854'>Binaries (Zip, 32 and 64 bit)</a></li>
						<li><a href='http://sourceforge.net/project/downloading.php?group_id=218233&amp;use_mirror=osdn&amp;filename=cfix-src-1.0.0-rc1.zip&amp;52270229'>Source (Zip)</a></li>
					</ul>
				</div>
				<div id='submenu'>
					<div id='submenuheader'>
				...
				<div id='submenu'>
					...
					<div style='text-align: center'>
						<a href='http://www.gnu.org/licenses/gpl.html'><img src='gpl.png' hspace='7' vspace='7' border='0' /></a>
					</div>
				</div>
			</div>
		</div>
