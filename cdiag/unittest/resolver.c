...
PCWSTR RegistratioInetDfr[] = { L"wininet.dll", L"cdiag.dll", /*L"dfrgres.dll",*/ 0 };
...
static MESSAGE_SAMPLE MessageSamples[] = 
{
	...
	//{ RegistratioInetDfr,	0x00003000, 0,															NULL,			L"Defrag ",				S_OK },	// dfrgres.dll
	{ RegistratioInetDfr,	0x00002EE2, 0,															Insertions,		L"The operation timed",	S_OK },	// wininet.dll
	{ RegistratioInetDfr,	0x10000000, 0,															Insertions,		L"",					CDIAG_E_UNKNOWN_MESSAGE},	

	// insertions
	{ RegistratioInetDfr,	0x800481ff,	CDIAG_MSGRES_RESOLVE_IGNORE_INSERTS,						NULL,			L"Test=%1,%2",		S_OK },
	{ RegistratioInetDfr,	0x800481ff,	CDIAG_MSGRES_RESOLVE_IGNORE_INSERTS,						Insertions,		L"Test=%1,%2",		S_OK },
	{ RegistratioInetDfr,	0x800481ff,	0,															Insertions,		L"Test=one,two",	S_OK },
	{ 0 }
};
