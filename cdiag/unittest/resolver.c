...
static MESSAGE_SAMPLE MessageSamples[] = 
{
	...
	// inserions
	{ RegistratioInetOle,	0xC0002714,	CDIAG_MSGRES_RESOLVE_IGNORE_INSERTS,						NULL,			L"DCOM got error \"%1\"",		S_OK },
	{ RegistratioInetOle,	0xC0002714,	CDIAG_MSGRES_RESOLVE_IGNORE_INSERTS,						Insertions,		L"DCOM got error \"%1\"",		S_OK },
...
static VOID TestResolveMessages()
{
	...
	for ( Sample = MessageSamples; Sample->Registrations != 0; Sample++ )
	{
		...
		//
		// Removing CRLFs should not cut the size by moe than 2.
		//
