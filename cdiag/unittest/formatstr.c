/*----------------------------------------------------------------------
 * Purpose:
 *		Test case for CdiagpFormatString
 *
 * Copyright:
...
extern HRESULT CDIAGCALLTYPE CdiagpFormatString(
	__in ULONG VarCount,
...
CFIX_BEGIN_FIXTURE( Internals )
	CFIX_FIXTURE_ENTRY( TestFormats )
	CFIX_FIXTURE_ENTRY( TestIntArgs )
CFIX_END_FIXTURE()
