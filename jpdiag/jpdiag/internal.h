...
typedef struct _FORMAT_VARIABLE
{
	...
	// for the data passed to JpdiagpFormatString.
	//
	PWSTR Format;
 ...
 *
 */
#define JpdiagpIsValidHandler( h ) \
	( ( ( h ) != NULL && ( ( PJPDIAG_HANDLER ) ( h ) )->Size == sizeof( JPDIAG_HANDLER ) ) )
