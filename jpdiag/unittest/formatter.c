...
{
	{ 0xFFFF,				L"(null)" },
	{ JpdiagLogEvent,		L"Log" },
	{ JpdiagAssertionEvent,	L"Assertion" },
	{ 0, 0 }
};
...
{
	{ JpdiagDebugSeverity,	L"Debug" },
	{ 0xFF,					L"(null)" },
	{ JpdiagFatalSeverity,	L"Fatal" },
	{ 0, 0 }
};
...
{
	{ JpdiagUserMode,	L"User" },
	{ JpdiagKernelMode, L"Kernel" },
	{ 0xFF,				L"(null)" },
	{ 0, 0 }
};
...
VOID TestFormatter()
{
	...
	TEST_HR( JpdiagCreateMessageResolver( &Resolver ) );
