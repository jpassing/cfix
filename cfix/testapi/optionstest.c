...
{
	{ L"debug",		CFIXRUN_EXIT_ALL_SUCCEEDED },
	{ L"console",	CFIXRUN_EXIT_ALL_SUCCEEDED },
	{ NULL,			CFIXRUN_EXIT_USAGE_FAILURE },
	{ L"asd",		CFIXRUN_EXIT_USAGE_FAILURE },
	{ L"",			CFIXRUN_EXIT_USAGE_FAILURE },
};
...
void TestOptions()
{
	...
	for ( FixtureIndex = 0; FixtureIndex < _countof( FixtureNames ); FixtureIndex++ )
	{
		...
		Options.DllOrDirectory	= DllOrDirectory[ DllIndex ].DllOrDirectory;
