	...
	)
{
	...
	wprintf( 
		...
		L"    -fsf           Shortcut fixture - when a test case fails, skip remaining test cases of\n"
		L"                   enclosing fixture\n"
		L"                   (Default: Report failure, but continue fixture)\n"
		L"    -fss           Shortcut testrun on failing setup - when a setup routine fails,\n"
		L"                   abort testrun\n"
		L"                   (Default: Shortcut fixture, but continue testrun)\n"
		L"    -fsr           Shortcut testrun - when a test case fails, abort testrun - \n"
