...
//
#define CFIX_FIXTURE_EXECUTION_SHORTCUT_FIXTURE_ON_FAILURE		1

//
// If a setup routine fails, prematurely abort run. The fixture
// will be aborted in anyway.
//
#define CFIX_FIXTURE_EXECUTION_SHORTCUT_RUN_ON_SETUP_FAILURE	2
...
// CFIX_FIXTURE_EXECUTION_SHORTCUT_RUN_ON_FAILURE instead.
//
#define CFIX_FIXTURE_EXECUTION_ESCALATE_FIXTURE_FAILUES			4

//
// If one routine fails, prematurely abort run.
// Implies CFIX_FIXTURE_EXECUTION_SHORTCUT_FIXTURE_ON_FAILURE and
// CFIX_FIXTURE_EXECUTION_SHORTCUT_RUN_ON_SETUP_FAILURE.
//
#define CFIX_FIXTURE_EXECUTION_SHORTCUT_RUN_ON_FAILURE			\
	( CFIX_FIXTURE_EXECUTION_SHORTCUT_FIXTURE_ON_FAILURE |		\
	  CFIX_FIXTURE_EXECUTION_SHORTCUT_RUN_ON_SETUP_FAILURE |	\
